...
must_haves:
  truths:
    - "i18next library is installed and configured for server-side use"
    - "Translation JSON files exist for all 4 languages (he, en, ru, ar)"
    - "Server can load translations dynamically based on language code"
  artifacts:
